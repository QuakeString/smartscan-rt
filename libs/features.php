...
class PDF_Fetures extends FPDF {
    function LineGraph($w, $h, $data, $options='', $colors=null, $maxVal=1, $nbDiv=4){
        /*******************************************
        ...
        *******************************************/
        ...
        foreach($valueKeys as $key => $value){
            if($key==0){
                ...
                //$this->RotatedText(30,$lineh-20,$value,90);
        ...
        for($i=0;$i<=$nbDiv;$i++){
            ...
            $this->Cell(8,6,intval($maxVal/$nbDiv*$i),0,0,'R');
        }
        $this->SetDrawColor(0,0,0);
        $this->SetLineWidth(0.2);
    }
